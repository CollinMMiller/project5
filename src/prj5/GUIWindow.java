...
public class GUIWindow {
    ...
    private void majorLegend()
    {
        ...
        window.moveToFront(heardText);
        heardText.setBackgroundColor(transparent);
        legend = new TextShape(612, 90, "Major Legend", 
            Color.BLACK);
        legend.setBackgroundColor(transparent);
        window.addShape(legend);
        window.moveToFront(legend);
        TextShape compS = new TextShape(612, 120, "Comp Sci", Color.MAGENTA);
        window.addShape(compS);
        compS.setBackgroundColor(transparent);
        window.moveToFront(compS);
        TextShape eng = new TextShape(612, 140, "Other Eng", Color.BLUE);
        window.addShape(eng);
        eng.setBackgroundColor(transparent);
        window.moveToFront(eng);
        TextShape math = new TextShape(612, 160, "Math/CMDA", Color.ORANGE);
        window.addShape(math);
        math.setBackgroundColor(transparent);
        window.moveToFront(math);
        TextShape other = new TextShape(612, 180, "Other", Color.GREEN);
    ...
    private void regionLegend()
    {
        ...
        window.moveToFront(heardText);
        heardText.setBackgroundColor(transparent);
        legend = new TextShape(612, 90, "Region Legend", 
            Color.BLACK);
        legend.setBackgroundColor(transparent);
        window.addShape(legend);
        window.moveToFront(legend);
        TextShape southE = new TextShape(612, 120, "Southeast", Color.MAGENTA);
        window.addShape(southE);
        southE.setBackgroundColor(transparent);
        window.moveToFront(southE);
        TextShape northE = new TextShape(612, 140, "Northeast", Color.BLUE);
        window.addShape(northE);
        northE.setBackgroundColor(transparent);
        window.moveToFront(northE);
        TextShape other = new TextShape(612, 160, "US(other)", Color.ORANGE);
        window.addShape(other);
        other.setBackgroundColor(transparent);
        window.moveToFront(other);
        TextShape non = new TextShape(612, 180, "non-US", Color.GREEN);
        window.addShape(non);
